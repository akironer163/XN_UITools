//
//  NSAttributedString+XNAdditon.h
//  XN_UITools
//
...
#import "NSAttributedString+XNAdditon.h"

@implementation NSAttributedString (XNAdditon)

+ (instancetype)XN_imageTextWithImage:(UIImage *)image imageWH:(CGFloat)imageWH title:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor spacing:(CGFloat)spacing {
